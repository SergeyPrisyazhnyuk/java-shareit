...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query(value = "select /*b.id as bookingId, b.start_date as bookingStartDate, b.end_date as bookingEndDate, b.status as bookingStatus, i.id as bookingItemId, i.name as bookingItemName, b.booker_id as bookingBookerId*/ b.* from bookings as b join items as i on i.id = b.item_id " +
            " where b.booker_id = ?1 " +
