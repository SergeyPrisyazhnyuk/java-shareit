...
public interface BookingService {
    ...
    List<BookingDtoReturn> getAll(Long userId, String state, Integer from, Integer size);

    List<BookingDtoReturn> getAllByOwner(Long userId, String state, Integer from, Integer size);
